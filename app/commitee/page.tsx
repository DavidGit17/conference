...
export default function Commitee() {
  return (
    <div className="pt-16 pb-16 px-32 h-fit bg-white">
      ...
      <div className="">
        <div>
          <h1 className="text-[#A71E25]">
            ORGANIZING <span className="text-black">COMMITTEE</span>
          </h1>
          <p className="text-black">
            Dr. G. Venkateswarlu, Assistant Professor, Dept. of CSA, KLEF Mr.
            N.Venkata Ramana, Assistant Professor, Dept. of CSA, KLEF Mr.
            R.Nagendra Babu, Assistant Professor, Dept. of CSA, KLEF Dr. Gufran
            Ahmad, Assistant Professor, Dept. of CSA, KLEF Mrs. T.Ratna Kumari,
            Assistant Professor, Dept. of CSA, KLEF
          </p>
        </div>
      </div>
