  ...
  return (
    <div className="pt-16 pb-16 lg:px-32 px-5 h-fit bg-white">
      ...
      <div className=" xl:lg:md:flex-row lg:flex  flex-col justify-between mt-10">
        <div className="bg-[#E7E7E7] rounded rounded-lg lg:w-[19rem] flex flex-col items-center py-10 lg:px-0 px-5  ">
          ...
          <div className="flex flex-col items-center pt-6 ">
            <p className="text-black open-sans-bold ">Dr.K. Subramanyam</p>
        ...
        <div className="bg-[#E7E7E7] rounded rounded-lg lg:w-[19rem] flex flex-col items-center py-10 lg:px-0 px-5 ">
          ...
          <div className="flex flex-col items-center pt-6">
            <p className="text-black open-sans-bold ">Dr.M.N.V Kiran Babu</p>
            <p className="text-black open-sans-regular text-center">
              Deputy HoD , Dept of CSA, KLEF
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="website bg-[#E7E7E7] rounded rounded-lg h-fit flex flex-col justify-center items-center text-center py-10 lg:px-0 px-7">
        ...
        <div className="">
          <p className="text-black inter-custom-bolder pb-3">
            Mr. A. Siddhartha Reddy,
