				...
				<div className={"bg-[url('./Group.jpeg')] bg-cover w-full bg-[#2D2D2D] " }>
					...
					<div className="flex flex-col h-full justify-between lg:px-20 px-3">
						...
						<div className=" flex flex-col w-full lg:h-64 h-48 justify-evenly items-center lg:pt-0 pt-8 lg:gap-0 gap-3 ">
							<div className="lg:h-12 lg:w-80 bg-[#D9D9D996]  rounded-lg flex flex-row text-black items-center font-semibold lg:text-lg lg:px-4 text-xs px-3 py-2 uppercase font-sans lg:ml-24 ">Conference Mode :<span className="ml-2  text-[#A71E25] font-cmg-sans-bold">  Hybrid</span></div>
