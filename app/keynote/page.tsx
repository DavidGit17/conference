...
export default function Keynote() {
  return (
    <div className="pt-12 pb-16 lg:px-32 px-3 h-fit bg-white">
      ...
      <div className="lg:md:w-full lg:h-screen h-fit  lg:mt-28 mt-10 lg:md:flex  justify-between">
        <div className="lg:md:w-[40%] h-full p-3">
          ...
          <div className="h-4/6 w-full ">
            <div className="h-2/6 w-full lg:mt-4 mt-7 flex flex-col items-center justify-center text-black">
              <p className="lg:text-xl text-lg"><b>Prof. P Suresh Varma</b></p>
              <p className="font-semibold ">M.Tech(CSE), Ph.D</p>
              <p className="font-semibold text-center">Dean Faculty of Engineering and Technology </p>
        ...
        <div className=" h-2/6 w-full flex justify-center items-center ">
          ...
          <div className="h-fit w-full mt-14 ">
            <div className="h-2/6 w-full mt-4 flex flex-col items-center justify-center text-black">
              <p className="lg:text-xl text-lg text-center"><b>Prof. Jagan Mohan Chevvakula</b></p>
              <p className="font-semibold">Industry Expert</p>
              <p className="font-semibold text-center">Director – R&D - Development at E2Open</p>
            </div>
            <div className="mt-6">
              <p className="font-open-sans text-black text-justify">
